...
- **Mise en place** : Télécharger le [dossier exo2](https://github.com/ClaudeGrasland/bivaR2023/raw/main/resources/exos/exo2.zip) et décompressez le sur votre ordinateur. Puis ouvrez le projet R `exo2.Rproj` dans Rstudio.
