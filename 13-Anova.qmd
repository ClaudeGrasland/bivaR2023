...
- **Mise en place** : Télécharger le [dossier exo6](https://github.com/ClaudeGrasland/bivaR2023/raw/main/resources/exos/exo6.zip) et décompressez le sur votre ordinateur. Puis ouvrez le projet R `exo6.Rproj` dans Rstudio.
