...
- **Mise en place** : Télécharger le [dossier exo8](https://github.com/ClaudeGrasland/bivar2023/raw/main/resources/exos/exo8.zip) et décompressez le sur votre ordinateur. Puis ouvrez le projet R `exo8.Rproj` dans Rstudio.
