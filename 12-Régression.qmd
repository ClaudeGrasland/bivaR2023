...
- **Mise en place** : Télécharger le [dossier exo5](https://github.com/ClaudeGrasland/startR/raw/master/resources/exos/exo5.zip) et décompressez le sur votre ordinateur. Puis ouvrez le projet R `exo5.Rproj` dans Rstudio.
