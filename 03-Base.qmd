...
- **Mise en place** : Télécharger le [dossier exo3](https://github.com/ClaudeGrasland/bivar2023/raw/main/resources/exos/exo3.zip) et décompressez le sur votre ordinateur. Puis ouvrez le projet R `exo3.Rproj` dans Rstudio.
